...
// The project and key both come from lib/supabaseEnv.js, which refuses to
// start when they are unset rather than falling back to a hardcoded project.
import { supabaseKey, supabaseUrl } from './supabaseEnv.js'

export { supabaseConnection } from './supabaseEnv.js'
