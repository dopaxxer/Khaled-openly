...
async function fetchApple(url, signal) {
  // Do not pass RequestInit.cache here. Cloudflare Workers can reject
  // unsupported cache modes depending on the deployed compatibility date.
  // Catalog caching is handled explicitly above instead.
